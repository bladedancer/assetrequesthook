...
module.exports = {
	...
	// API key
	apikey: process.env.APIKEY || 'olttRcztCOwBPihJXmaKOkxnm0qVvU5E',

	// This is the base url the service will be reachable at not including the
	// port
	baseurl: 'https://bladedancer.asuscomm.com/',
	...
	ssl: {
		port: parseInt(process.env.SSLPORT) || 8443,
		key: fs.readFileSync(path.join('.', 'pem','key.pem'), 'utf8'),
		cert: fs.readFileSync(path.join('.', 'pem','cert.pem'), 'utf8')
	},
	...
	session: {
		...
		encryptionKey: 'fbqWtn+Kmbt1KMUtyaiSKrPeeiISVv4Piv+P9BZWMjE=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'ae1Q+owPDQrYVzm8mViVWD1i6dLogxllttRdoUcCxMUetCc8aZ6QZ3vp6+pjsYyKFv4tNVXqYCgJxWA3AOnlUg==',
		// should be a large unguessable string
		secret: '24YpjEWQboq4oUmgMVmJ3nRQbs/g+rA7',
	...
	cookieSecret: 'Fr5C3URlSvs6tOixLhA5ZiVeQ6Z3zIBh',
	...
	authorization: {
		...
		credentials: {
			central: {
				...
				basic_auth: true,
				token_url: 'https://login.axwaytest.net/auth/realms/Broker/protocol/openid-connect/token',
				client_id: '',
				client_secret: '',
				access_token: null
			}
